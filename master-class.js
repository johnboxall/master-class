...
(function(window, document) {
    ...
    var testWindow = 'defaultView' in test.ownerDocument ? test.ownerDocument.defaultView : el.ownerDocument.parentWindow;
    var color = testWindow.getComputedStyle(test, null).getPropertyValue('color'),
        m = /255(\))?/gi.exec(color);
    if (m) {
